...
<div class="container">
    ...
    @endif
    <div class="table-with-scrollbar table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                @foreach($data as $datas)
                    ...
                    <form action="{{ url('/approveDirektur') }}/{{ $datas->NoSPK }}" method="post">
                        @csrf
                        <tr>
                            ...
                            @elseif ($cekapprove == 'PresDir')
                                <td style="min-width: 170px !important;">
                                    <select name="status" id="" class="form-control">
                                        <option value="11">Need Approval</option>
                                        <option value="1">Pass On PresDir</option>
                                        <option value="13">Rejected</option>
                                    </select>
                                </td>
                            @else
