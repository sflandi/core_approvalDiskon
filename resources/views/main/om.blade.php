...
<div class="container">
    ...
    <div class="table-with-scrollbar">
        <table class="table table-striped table-bordered table-hover"  style="border-radius: 0 15px 0 0 !important;">
            <thead>
            ...
            <tbody>
                @foreach($data as $datas)
                    ...
                    <!-- {{$approve = strtoupper($datas->nama)}} -->
                    <!-- {{$cekapprove = strtoupper($datas->approvalperson)}} -->
                    @if ($approve == 'OM' || $approve == 'Direktur' && $cekapprove == 'Direktur')
                    <form action="{{ url('/approveOm') }}/{{ $datas->NoSPK }}" method="post">
                        @csrf
                        <tr class="GridViewScrollItem" style='background:rgba(255, 71, 87, 1); color:white;'>
                        ...
                        <tr class="GridViewScrollItem" >
                            ...
                            <td style="min-width: 170px !important;">
                                <select name="status" id="" class="form-control">
                                    ...
                                    <option value="1">PassOn OD</option>
